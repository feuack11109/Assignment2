...
def load_data():
    ...
    data_path = r"C:\streamlit\data"

    offences = pd.read_csv(f"{data_path}\\offences_subset_cleaned.csv")
    victims = pd.read_csv(f"{data_path}\\victims_subset_cleaned.csv")
    trafficking = pd.read_csv(f"{data_path}\\cleaned_offences_of_trafficking_in_persons.csv")
    convicted = pd.read_csv(f"{data_path}\\convicted_focus_rape_trafficking.csv")
    personnel = pd.read_csv(f"{data_path}\\criminal_justice_personnel_cleaned.csv")
    prosecuted = pd.read_csv(f"{data_path}\\prosecuted_focus_rape_trafficking.csv")
    sdg_safety = pd.read_csv(f"{data_path}\\sdg_dataset_perception_of_safety_clean.csv")
